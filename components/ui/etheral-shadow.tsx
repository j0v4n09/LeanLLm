...
export function Component({
  ...
  const feColorMatrixRef = React.useRef<SVGFEColorMatrixElement>(null);
            ...
            <defs>
              <filter id={id}>
                <feTurbulence
                  ...
                  numOctaves="2"
                  baseFrequency={`${
                    animation ? mapRange(animation.scale, 0, 100, 0.001, 0.0005) : 0.001
                  },${animation ? mapRange(animation.scale, 0, 100, 0.004, 0.002) : 0.004}`}
                  seed="0"
                  type="turbulence"
                />
